    ...
    cond_cameras: dict[str, CameraConfig] = field(
        default_factory=lambda: {
            "camera1": OpenCVCameraConfig(
                ip="192.168.1.91",
                username="admin",
                password=os.environ.get("CAMERA_1_PASSWORD", None),
                rtsp_port=554,
                width=1920,
                height=1080,
                fps=5,
            ...
            "camera2": OpenCVCameraConfig(
                ip="192.168.1.92",
                username="admin",
                password=os.environ.get("CAMERA_2_PASSWORD", None),
                rtsp_port=554,
                width=1920,
                height=1080,
                fps=5,
            ...
            "camera3": OpenCVCameraConfig(
                ip="192.168.1.93",
                username="admin",
                password=os.environ.get("CAMERA_3_PASSWORD", None),
                rtsp_port=554,
                width=1920,
                height=1080,
                fps=5,
            ...
            "camera4": OpenCVCameraConfig(
                ip="192.168.1.94",
                username="admin",
                password=os.environ.get("CAMERA_4_PASSWORD", None),
                rtsp_port=554,
                width=1920,
                height=1080,
                fps=5,
            ...
            "camera5": OpenCVCameraConfig(
                ip="192.168.1.95",
                username="admin",
                password=os.environ.get("CAMERA_5_PASSWORD", None),
                rtsp_port=554,
                width=1920,
                height=1080,
                fps=5,
